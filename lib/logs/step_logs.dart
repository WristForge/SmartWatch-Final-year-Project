...
class _StepLogsScreenState extends State<StepLogsScreen> {
  ...
  Map<String, int> stepData = {}; // map of time period to steps
  ...
  List<FlSpot> generateGraphSpots() {
    List<FlSpot> spots = [];
    List<String> keys = stepData.keys.toList();
    keys.sort(); // Assuming keys are timestamps or formatted dates
                  ...
                  DropdownButton<String>(
                    ...
                    onChanged: (String? newValue) {
                      setState(() {
                        ...
                        // TODO: Filter stepData according to selectedView
                      });
                    },
